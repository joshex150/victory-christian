...
const Patch = z
  .object({
    ...
    formNameLabel: z.string().max(100).optional(),
    formNamePlaceholder: z.string().max(100).optional(),
    ...
    upcomingFormNameLabel: z.string().max(100).optional(),
    upcomingFormNamePlaceholder: z.string().max(100).optional(),
